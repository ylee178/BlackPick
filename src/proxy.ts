...
// Root-level Next.js metadata file conventions. These are generated by files
// like src/app/opengraph-image.tsx and must be served as-is without a locale
// prefix — otherwise next-intl redirects /opengraph-image → /en/opengraph-image
// which 404s because the file convention lives at the app root, not in [locale].
