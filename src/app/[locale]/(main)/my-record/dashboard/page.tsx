    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap gap-2">
        {RANGES.map((r) => (
          <Link
            key={r}
            href={r === "all" ? "/my-record/dashboard" : `/my-record/dashboard?range=${r}`}
            ...
            <div className="flex items-center gap-5">
              ...
              <div className="min-w-0">
                ...
                <div className="mt-1 flex items-center gap-2 text-base tabular-nums text-[var(--bp-muted)]">
                  <span>
                    <span className="text-[#4ade80]">{displayWins}W</span> <span className="text-[#f87171]">{displayLosses}L</span>
                  </span>
                  {winDelta != null && (
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0">
                            ...
                            <p className="mt-0.5 text-xs tabular-nums text-[var(--bp-muted)]">
                              <span className="text-[#4ade80]">{stat.wins}W</span> <span className="text-[#f87171]">{stat.losses}L</span>
                            </p>
                          </div>
                          <p
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mt-2 flex items-center justify-between">
                        <p className="text-xs tabular-nums text-[var(--bp-muted)]">
                          <span className="text-[#4ade80]">{ev.wins}W</span> <span className="text-[#f87171]">{ev.losses}L</span>
                          <span className="ml-1.5 text-xs text-[var(--bp-muted)] opacity-60">
                            ({evWinRate}%)
                          </span>
                        </p>
                        <p
